...
import { handleAdminMobileDeepLink, useDeepLinkHandler } from '../src/linking/useDeepLinkHandler';
...
function Bootstrap() {
  ...
  useEffect(() => {
    ...
    void registerPush(apiClient, 'admin_mobile');
  }, [session]);
  ...
  return (
    <>
      ...
      <ForegroundPushBanner
        onOpen={(path) => void handleAdminMobileDeepLink(path, router, apiClient)}
      />
    </>
  );
}
